...
class TweetDBHandler:
    ...
    def insert_tweet(tweet: Tweet, db_handler: DBHandler):
        query = (
            "INSERT INTO tcorstwitter.tweets (id, createdAt, text, userId, isRetweet, latitude, longitude, place_country, place_name, place_type) "
    ...
    def insert_user(user: TwitterUser, db_handler: DBHandler):
        query = (
            "REPLACE INTO twitter_profiles(userId, description, friendsCount, followersCount, screenName, statusesCount, location, name) "
